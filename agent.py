...
def comprehensive_test():
    ...
    sorted_reults
    best_choice = (
    max(set(best_choice_alpha), key=best_choice_alpha.count), max(set(best_choice_gamma), key=best_choice_gamma.count),
    max(set(best_choice_epsilon), key=best_choice_epsilon.count))
    print
